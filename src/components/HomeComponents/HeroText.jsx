...
function HeroText() {
  return (
    <div className='mt-12'>
      <h2 class=" text-4xl sm:text-5xl md:text-7xl items-center justify-center font-Zumme text-daBrown text-center mt-6 font-semibold">HackXila <br /> Where Ideas  Take Flight
</h2>
