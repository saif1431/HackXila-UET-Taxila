...
function Highlights() {
  ...
  const galleryImages = [
    ...
    { id: 4, src: '/team/teamImage9.png', alt: 'Event 2' },
    { id: 5, src: '/team/teamImage7.png', alt: 'Event 2' },
    { id: 6, src: '/team/teamImage1.png', alt: 'Event 2' },
    { id: 7, src: '/team/teamImage15.png', alt: 'Event 2' },
    { id: 8, src: '/team/teamImage16.png', alt: 'Event 2' },
    { id: 9, src: '/team/teamImage11.png', alt: 'Event 2' },
    { id: 10, src: '/team/teamImage6.png', alt: 'Event 2' },
    { id: 11, src: '/team/teamImage2.png', alt: 'Event 2' },
    { id: 12, src: '/team/teamImage13.png', alt: 'Event 2' },
    { id: 13, src: '/team/teamImage14.png', alt: 'Event 2' },
    { id: 14, src: '/team/teamImage5.png', alt: 'Event 2' },
    { id: 15, src: '/team/teamImage10.png', alt: 'Event 2' },
    { id: 16, src: '/team/teamImage3.png', alt: 'Event 2' },
    { id: 17, src: '/team/teamImage18.png', alt: 'Event 2' },
    { id: 18, src: '/team/teamImage8.png', alt: 'Event 2' },
    { id: 19, src: '/team/teamImage12.png', alt: 'Event 2' },
  ];
