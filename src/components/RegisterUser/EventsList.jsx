...
function EventsList() {
  return (
    <div>
      ...
      <div class="mt-5 flex flex-col items-center justify-center text-center"><h2 class="mb-3 text-xl sm:text-xl md:text-5xl items-center justify-center font-Zumme text-daBrown">JOIN US BY REGISTERING FOR AN</h2><h2 class="mb-3 text-xl sm:text-3xl md:text-5xl text-blue font-Zumme text-daBrown">EVENT</h2></div>
      <div className='px-6'>
      <EventDetail/>
      </div>
    </div>
